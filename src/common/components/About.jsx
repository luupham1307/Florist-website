            ...
            <div>
                ...
                <div>
                    <div className="relative">
                        <img className=" h-[535px] sm:w-full object-cover pb-[15px] " src="https://zjuxinjcqrcvncurfkwx.supabase.co/storage/v1/object/public/Image/About/about-video.jpg" alt=" about" />
                    ...
                    <div className="mb-[30px] px-[50px] py-[70px] shadow-[0_10px_21px_0px_rgba(99,134,137,0.16)] bg-white">
